  ...
  for (int is_big = 0; is_big < 2; ++is_big) {
    for (int val_in = 0; val_in < message_max; ++val_in) {
      ...
      if (is_big == 1) {
        ...
        int encrypt_left_ok = shortint_client_key_encrypt_small(cks, in, &ct_in);
        assert(encrypt_left_ok == 0);
      }
  ...
  for (int is_big = 0; is_big < 2; ++is_big) {
    for (int in = 0; in < message_max; ++in) {
      ...
      if (is_big == 1) {
        ...
        int encrypt_left_ok = shortint_client_key_encrypt_small(cks, in, &ct_in_and_result);
        assert(encrypt_left_ok == 0);
      }
    ...
    for (int val_left = 0; val_left < message_max; ++val_left) {
      for (int val_right = 0; val_right < message_max; ++val_right) {
        ...
        if (is_big == 1) {
          ...
          int encrypt_left_ok = shortint_client_key_encrypt_small(cks, left, &ct_left);
          assert(encrypt_left_ok == 0);

          int encrypt_right_ok = shortint_client_key_encrypt_small(cks, right, &ct_right);
          assert(encrypt_right_ok == 0);
        }
    ...
    for (int val_left = 0; val_left < message_max; ++val_left) {
      for (int val_right = 0; val_right < message_max; ++val_right) {
        ...
        if (is_big == 1) {
          ...
          int encrypt_left_ok = shortint_client_key_encrypt_small(cks, left, &ct_left_and_result);
          assert(encrypt_left_ok == 0);
...
void test_server_key(void) {
  ...
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, left_shift,
                                 (BinaryScalarCallback)shortint_server_key_smart_scalar_left_shift,
                                 NULL, 0);
  test_shortint_binary_scalar_op(
      deser_cks, deser_sks, message_bits, carry_bits, left_shift,
  ...
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, right_shift,
                                 (BinaryScalarCallback)shortint_server_key_smart_scalar_right_shift,
                                 NULL, 0);
  test_shortint_binary_scalar_op(
      deser_cks, deser_sks, message_bits, carry_bits, right_shift,
  ...
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_add,
                                 (BinaryScalarCallback)shortint_server_key_smart_scalar_add, NULL,
                                 0);
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_add,
                                 (BinaryScalarCallback)shortint_server_key_unchecked_scalar_add,
                                 NULL, 0);
  ...
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_sub,
                                 (BinaryScalarCallback)shortint_server_key_smart_scalar_sub, NULL,
                                 0);
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_sub,
                                 (BinaryScalarCallback)shortint_server_key_unchecked_scalar_sub,
                                 NULL, 0);
  ...
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_mul,
                                 (BinaryScalarCallback)shortint_server_key_smart_scalar_mul, NULL,
                                 0);
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_mul,
                                 (BinaryScalarCallback)shortint_server_key_unchecked_scalar_mul,
                                 NULL, 0);
  ...
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_greater,
                                 (BinaryScalarCallback)shortint_server_key_smart_scalar_greater,
                                 NULL, 0);

  printf("scalar_greater_or_equal\n");
  test_shortint_binary_scalar_op(
      deser_cks, deser_sks, message_bits, carry_bits, scalar_greater_or_equal,
  ...
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_less,
                                 (BinaryScalarCallback)shortint_server_key_smart_scalar_less, NULL,
                                 0);

  printf("scalar_less_or_equal\n");
  test_shortint_binary_scalar_op(
      deser_cks, deser_sks, message_bits, carry_bits, scalar_less_or_equal,
  ...
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_equal,
                                 (BinaryScalarCallback)shortint_server_key_smart_scalar_equal, NULL,
                                 0);

  printf("scalar_not_equal\n");
  test_shortint_binary_scalar_op(deser_cks, deser_sks, message_bits, carry_bits, scalar_not_equal,
                                 (BinaryScalarCallback)shortint_server_key_smart_scalar_not_equal,
                                 NULL, 0);
