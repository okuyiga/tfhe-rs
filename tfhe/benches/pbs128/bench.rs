...
fn criterion_bench(c: &mut Criterion) {
    {
        use tfhe::core_crypto::fft_128_impl::crypto::bootstrap::{
            bootstrap_scratch, Fourier128LweBootstrapKey,
        };
        use tfhe::core_crypto::fft_128_impl::math::fft::Fft128;
        ...
        c.bench_function("split-pbs128", |b| {
            b.iter(|| {
                fourier_bsk.as_view().bootstrap_u128(
                    pbs_multiplication_ct.as_mut(),
                    lwe_ciphertext_in.as_ref(),
                    accumulator.as_view(),
                    fft,
